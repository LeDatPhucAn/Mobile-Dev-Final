...
Sections 1--5 establish the application context and requirements. Sections 6--12 describe the architecture and implementation. Sections 13--14 document setup and installation. Sections 15--19 present validation, self-assessment, limitations, work allocation, and the demonstration plan.
...
The self-assessment maps implemented capabilities and documented evidence to the course marking rubric. A capability is classified as implemented when it is supported by an identifiable source component and relevant audit or test evidence. The implementation criteria account for 90\% of the available marks; report, presentation, and collaboration account for the remaining 10\%. Final grading remains subject to assessor review.
